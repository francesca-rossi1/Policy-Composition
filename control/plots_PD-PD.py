...
def capture_env_image(env, width=4000, height=3000):
    ...
    view = cam[2]
    proj = cam[3]
    # White background (comment previous command)
...
def render_overlay_figure1(
    ...
    print("Saved overlay figure →", path)
